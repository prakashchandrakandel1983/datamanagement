...
*Instructor: Dr. Adam Okulicz-Kozaryn				
				
*Prakash Chandra Kandel
*COLLDATA MANAGEMENT 56:824:718:01
*DATA on South Asia
...
1- Do various development indicators like literacy, unemployment rate, and per capita health expenditure affect extreme poverty?
...
The World Bank defines extreme poverty as living on less than 1.90 int.-$. 
...
rename TA Year2017
rename TB Year2018
rename TC Year2019 //the dataset does not have the data for 2020
...
assessments and opinion surveys." The CPI generally defines corruption as 
an "abuse of entrusted power for private gain". The index is published 
...
misstable sum 
// the variables corruption perception, positive effect, and negative effect have 6 missing data each for the Maldives
...
*************************REGRESSIONS******************************************
 ...
 /* The first regression will be about finding the relationship between poverty and human development indicators such as literacy rate, health expenditure, and unemployment rate*/
...
reg extremepov literacy unemp_rate health_exp, r //adding health expenditure per capita rate in the mix
outreg2 using poverty.xls, dec(2) excel e(all) append

/*For every one percentage point increase in average literacy rate leads to 3% drop in average extreme poverty rate for South Asian countries. However, the unemployment rate is positively associated with extreme poverty rate, coontrolling for other variables. Nonetheless, the effects are statistically not significant. On the other hand, one dollar increase in the health expenditure per capita is associated with 0.007 percentage point drop in extreme poverty, controlling for other variables, and the effect of the coefficient is statitically significant.  */
...
di upper("text manipulations in stata")
...
use unemployment, clear //This command had to be used again to display the dataset.
browse

/*DISCUSSION & CONCLUSION
1. It appears that both literacy and unemployment  do not have significant effect on extreme poverty. Most possibly other variables are required for identifying whether the effect is significant, or maybe more data is required to find out the effects of the regressors on extreme poverty. However, health expenditure per capita seems to have statistically significant effect on reduction on extreme poverty, even with the limited availability of data.

2. The coefficients happiness parameters such as social support, healthy life expectancy at birth, freedom to make life choices, and generosity weigh significantly on subjective wellbeing. The GDP does not have explanatory power on how people think about their lives. Therefore, for a country to be happy, any government that comes to power should faciliate these parameters by formulating enduiring policies.

3. Political rights and Civil liberties have significant effect on subjecttive wellbeing. Therefore, despite the limitations posed by the dataset, it is clear that people are happier if they are allowed to participate in political and civilian activities freely without fear.
*/
